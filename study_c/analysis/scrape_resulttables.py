...
# Create URL object
url = 'https://skatingscores.com/q/event/?show_ranks=on&underline=&' \
      'season_codes=2022&division_codes=sr&division_codes' \
      '=jr&event_codes=oly&discipline_codes=pairs&' \
      'unit_country_codes=all&unit_name=%25&sort=score&limit=50&submit' \
      '=Submit '
